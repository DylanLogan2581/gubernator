...
| ---------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Epic 3** | Admin-only (manual, operator-driven) | World Admin / Super Admin via the dedicated partnership mutation RPCs (`create_partnership`, `dissolve_partnership`, `mark_partnership_widowed`, `reassign_partner`). Operator is recorded on `changed_by_user_id`, with a free-text `change_reason`. A paired turn log entry is written by the data layer. |
