-- Migration: fix_notification_count_out_param
-- Fixes notification_count out-param in
-- internal_apply_turn_transition_log_entries_and_notifications: each type
-- previously accumulated count(*) of matching log entries instead of the number
-- of notification rows actually inserted. Replace with GET DIAGNOSTICS ROW_COUNT
-- after each INSERT so the value reflects rows written to public.notifications.
-- ---------------------------------------------------------------------------
