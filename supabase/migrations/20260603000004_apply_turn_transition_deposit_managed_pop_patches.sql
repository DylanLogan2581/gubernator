-- Migration: apply_turn_transition_deposit_managed_pop_patches
-- §C30: Extends apply_turn_transition to consume depositUpdates and
-- managedPopulationUpdates payload keys. Depleted deposits and extinct
-- populations have their citizen_assignments rows deleted as part of the
