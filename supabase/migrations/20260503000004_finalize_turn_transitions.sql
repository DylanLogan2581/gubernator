-- Migration: finalize_turn_transitions
-- Finalizes turn transition rows inside the turn-advance RPC while preserving
-- all-or-nothing world advancement behavior for downstream failures.
-- ---------------------------------------------------------------------------
