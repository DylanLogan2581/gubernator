-- Migration: apply_turn_transition_advance_world_turn
-- §C35: Extends apply_turn_transition to:
--   1. Advance worlds.current_turn_number to p_expected_turn_number + 1.
--   2. Reset settlement readiness: is_ready_current_turn = auto_ready_enabled,
--      ready_set_at = NULL, ready_set_by_citizen_id = NULL.
--   3. Store readiness_summary_jsonb on the turn_transitions row.
--   4. Include currentTurnNumber in the returned payload.
--
-- This replaces the readiness-reset path previously in advance_world_turn_if_current.
-- ---------------------------------------------------------------------------
