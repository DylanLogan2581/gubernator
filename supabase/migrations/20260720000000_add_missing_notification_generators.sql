-- Migration: add_missing_notification_generators
-- Adds generator branches for five notification categories that were dropped in
-- 20260629000002_generate_notifications_from_log_entries.sql: trade_route.paused,
-- trade_route.resumed, construction.paused, partnership.formed, and
-- partnership.widowed. All five are settlement-scoped (log entries carry
-- settlement_id from the origin settlement or settlement where the event occurred).
-- ---------------------------------------------------------------------------
