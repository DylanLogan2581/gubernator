-- Migration: apply_turn_transition_citizen_partnership_patches
-- §C32: Extends apply_turn_transition to consume citizenBirths, citizenDeaths,
-- partnershipChanges, assignmentClears, and bornOnTurnBackfill payload keys.
-- Also stamps manual_deconstruct_overshoot log entries with the current
-- turn_transition_id per decision §11.6.
-- ---------------------------------------------------------------------------
