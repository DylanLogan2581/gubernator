  ...
  lives_ok (
    $test$
      select * from public.replace_trade_route(
        '5ef80000-0000-0000-0000-000000000007',
        '{"origin_settlement_id":"5e400000-0000-0000-0000-000000000001","destination_settlement_id":"5e400000-0000-0000-0000-000000000002","resource_id":"5e500000-0000-0000-0000-000000000001","quantity_per_transition":15}'::jsonb,
        '5ed00000-0000-0000-0000-000000000003'
      )
    $test$,
