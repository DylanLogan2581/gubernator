...
//   (see useEffectiveCanAdmin); shows an "Admin paused" badge plus a one-click
//   Clear button to drop the active PC and restore admin access.
...
export function ActiveCharacterSwitcher({
  ...
  return (
    <div className="inline-flex items-center gap-2">
      {canAdmin ? <AdminPausedBadge /> : null}
      ...
      {canAdmin ? (
        <Button
          ...
          disabled={isPending}
          onClick={clear}
          aria-label="Clear active character"
