...
export default defineConfig([
  // src/components/ui holds shadcn/ui primitives generated by the shadcn CLI.
  // They are vendored, not hand-authored, so we don't lint them (e.g. React 19
  ...
  ]),
  {
    ...
    rules: {
      ...
      // target). Disable the duplicate so a single linter governs effect deps.
